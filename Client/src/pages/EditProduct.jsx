      ...
      <Layout>
        <div className="EditProduct__title">
          <div className="container">
            <p className='title'>Редактирование объявления</p>
          </div>
        </div>
        <div className="newProduct__content">
          ...
          <div className="newProduct__create-product mb">
            <div className="container">
              <button className="newProduct__create-btn btn btn-Noactive" onClick={handleUpdate}>
                Обновить объявление
              </button>
              <button className="newProduct__create-btn btn btn-active" onClick={handleDelete}>
                Удалить объявление
              </button>
            </div>
          </div>
